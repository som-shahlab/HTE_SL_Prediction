...
bartSurv0 <- mc.surv.bart(x.train=sprint_sae0[,3:dim(sprint_sae0)[2]],
                          times=ceiling(sprint_sae0$t_saes/30),
                          delta=sprint_sae0$sae,
                          ntree=50,
...
# save results 
risk_bart_sae <- data.frame(Tbart_risk_control_sae)
write.csv(risk_bart_sae, paste0("./sae_tuned_results/external_T0bart_sae.csv"), row.names = F)
