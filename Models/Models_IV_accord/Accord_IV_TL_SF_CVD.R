...
risk_sf_cvd <- data.frame(testIndexes,Tsf_risk_control_cvd,Tsf_risk_treated_cvd)
write.csv(risk_sf_cvd, paste0("./cvd_tuned_results/accord_IV_TL_sf_cvd",i,".csv"), row.names = F)
