...
bartSurv0 <- mc.surv.bart(x.train=sprint_cvd0[,3:dim(sprint_cvd0)[2]],
                          times=ceiling(sprint_cvd0$t_cvds/30),
                          delta=sprint_cvd0$cvd,
                          ntree=50,
...
write.csv(risk_bart_cvd, paste0("./cvd_tuned_results/external_T0bart_cvd.csv"), row.names = F)
