...
# save results 
risk_gbm_cvd <- data.frame(testIndexes, Tgbm_risk_control_cvd, Tgbm_risk_treated_cvd)
write.csv(risk_gbm_cvd, paste0("./cvd_tuned_results/accord_IV_TL_gbm_cvd",i,".csv"), row.names = F)
